...
public class ViewDaoImpl implements ViewDao{
	...
	public List<CircleVo> listOptionTbSeoul(OptionTbVo tbvo) {
		String statement = "";
		List<CircleVo> list = null;		
		statement = "resource.OptionMapper.selectOptionSeoulList";
		System.out.println(tbvo);
		list = session.selectList(statement,tbvo);
		return list;
	}
	...
	@Override
	public DetailAptVo listOneApartment(int no) {
		String statement = "resource.OptionMapper.newlistOneApartment";
		DetailAptVo vo = session.selectOne(statement, no);
		return vo;
	}
	...
	public List<CatDataVo> categoryList(OptionInfoTbVo vo){
		String statement="resource.CatMapper.selectCatList2";
